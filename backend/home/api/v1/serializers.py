...
class UpdateUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'name', 'user_type', 'linkedin_profile_url', 'profile_picture']


class UserProfileSerializer(serializers.ModelSerializer):
    resume = serializers.FileField(required=True)
    hourly_rate = serializers.FloatField(required=True)
    expert_bio = serializers.CharField(required=True)
    weekly_availability = serializers.CharField(required=True)
